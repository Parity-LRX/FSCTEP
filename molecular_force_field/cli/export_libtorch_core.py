...
def _default_trace_num_nodes_edges(mode: str) -> tuple[int, int]:
    if mode in {"pure-cartesian-ictd", "pure-cartesian-ictd-o3", "pure-cartesian-ictd-save", "pure-cartesian-ictd-save-multiple", "pure-cartesian-ictd-save-o3"}:
        return 2048, 32000
    return 32, 256
    ...
    *,
    ...
    effective_jit_mode = str(jit_mode) if jit_mode is not None else (
        ...
        if (
            ...
            or mode in {"pure-cartesian-ictd", "pure-cartesian-ictd-o3", "pure-cartesian-ictd-save", "pure-cartesian-ictd-save-multiple", "pure-cartesian-ictd-save-o3"}
        )
        else "trace"
    )
...
def main() -> None:
    ...
    p.add_argument("--mode", type=str, default=None,
                   help="Model mode. If not set, restore from checkpoint metadata. "
                        "Supported: pure-cartesian-ictd, pure-cartesian-ictd-o3, pure-cartesian-ictd-save, pure-cartesian-ictd-save-multiple, pure-cartesian-ictd-save-o3, spherical-save-cue")
    ...
    p.add_argument("--trace-num-nodes", type=int, default=None,
                   help="Representative node count used during TorchScript tracing. "
                        "Default: 2048 for pure-cartesian-ictd / pure-cartesian-ictd-o3 / pure-cartesian-ictd-save / pure-cartesian-ictd-save-multiple / pure-cartesian-ictd-save-o3, else 32.")
    p.add_argument("--trace-num-edges", type=int, default=None,
                   help="Representative edge count used during TorchScript tracing. "
                        "Default: 32000 for pure-cartesian-ictd / pure-cartesian-ictd-o3 / pure-cartesian-ictd-save / pure-cartesian-ictd-save-multiple / pure-cartesian-ictd-save-o3, else 256.")
